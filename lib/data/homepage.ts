...
export const DESTINATION_HIGHLIGHTS: DestinationItem[] = [
  ...
  },
  {
    id: "5",
    number: "05",
    title: "NORWEGIAN FJORDS & ALASKA",
    regionSlug: "nordics-alaska",
    destSlug: "geirangerfjord",
    subtitle: "Geirangerfjord • Lofoten Islands • Glacier Bay",
    description: "Navigate dramatic glacial fjords, cascading waterfalls, midnight sun, and wild polar wildlife on a ice-strengthened explorer yacht.",
    image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1600&q=80",
    highlights: ["Glacier Bay Navigation", "Northern Lights Mooring", "Heli-Skiing Excursions"],
  },
  {
    id: "6",
    number: "06",
    title: "MALDIVES & SEYCHELLES",
    regionSlug: "indian-ocean",
    destSlug: "male-atoll",
    subtitle: "Baa Atoll • North Malé • Praslin • La Digue",
    description: "Private island hopping across coral lagoons, UNESCO biosphere reserves, and secluded anchorages in warm Indian Ocean waters.",
    image: "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?auto=format&fit=crop&w=1600&q=80",
    highlights: ["UNESCO Biosphere Diving", "Private Sandbank Banquets", "Whale Shark Encounters"],
  },
  {
    id: "7",
    number: "07",
    title: "RED SEA & ARABIAN GULF",
    regionSlug: "middle-east",
    destSlug: "dubai-musandam",
    subtitle: "Dubai • Musandam Fjords • Saudi Red Sea",
    description: "Blend modern architectural wonders with untouched coral reefs, ancient trading sea routes, and ultra-private desert anchorages.",
    image: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=1600&q=80",
    highlights: ["Dubai Harbor Superyacht Berth", "Musandam Fjord Cruises", "Red Sea Coral Reefs"],
  },
  {
    id: "8",
    number: "08",
    title: "ANTARCTICA & EXTREME LATITUDES",
    regionSlug: "polar",
    destSlug: "paradise-harbour",
    subtitle: "Paradise Harbour • Deception Island • Lemaire",
    description: "The ultimate frontier of superyachting. Icebreaker navigation past gargantuan icebergs, penguin colonies, and untouched wilderness.",
    image: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=1600&q=80",
    highlights: ["Icebreaker Navigation", "Submersible Polar Dives", "Zodiac Wildlife Expeditions"],
  },
];
...
export const TESTIMONIALS: Testimonial[] = [
  {
    id: "1",
    quote: "VELANTIS delivered an unforgettable charter experience in the Amalfi Coast. The attention to detail from the crew and broker was second to none.",
