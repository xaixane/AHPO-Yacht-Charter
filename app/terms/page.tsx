...
export const metadata = buildMetadata({
  ...
  description: "AHPO Yachts Terms of Service governing website usage, MYBA charter agreement standards, and advisory representations.",
  path: "/terms",
});
  ...
  return (
    <div className="min-h-screen bg-white text-[#0F0F0E]">
      <PageHeader
        ...
        title="Terms of Service"
        description="General terms governing the use of AHPO Yachts digital platforms and charter brokerage services."
      ...
      <section className="py-20 px-6 sm:px-12 lg:px-16 max-w-4xl mx-auto space-y-12">
        <div className="prose max-w-none text-[#6B6B65] space-y-6 text-sm sm:text-base">
          ...
          <p>
            AHPO Yachts acts as a charter broker representing charterers and yacht owners under Mediterranean Yacht Brokers Association (MYBA) standard contract frameworks. Website listings do not constitute binding charter contracts until executed in writing.
          </p>
